...
class ImdbspiderSpider(scrapy.Spider):
    ...
    def parse(self, response):
        film_relative_urls = response.css(".ipc-metadata-list-summary-item__tc a::attr(href)")
    ...
    def parse_film(self, response):
        ...
        name =  response.xpath('//*[@id="__next"]/main/div/section[1]/section/div[3]/section/section/div[2]/div[1]/h1/span/text()').get()
        score = response.xpath('//*[@id="__next"]/main/div/section[1]/section/div[3]/section/section/div[2]/div[2]/div/div[1]/a/span/div/div[2]/div[1]/span[1]/text()').get()
        top_rate = response.xpath('//*[@id="__next"]/main/div/section[1]/div/section/div/div[1]/section[1]/div/div/a/text()').get()

        year =  response.xpath('//*[@id="__next"]/main/div/section[1]/section/div[3]/section/section/div[2]/div[1]/ul/li[1]/a/text()').get()
        length = response.xpath('//*[@id="__next"]/main/div/section[1]/section/div[3]/section/section/div[2]/div[1]/ul/li[3]/text()').get()
        popularity = response.xpath('//*[@id="__next"]/main/div/section[1]/section/div[3]/section/section/div[2]/div[2]/div/div[3]/a/span/div/div[2]/div[1]/text()').get()
        storyline = response.xpath('//*[@id="__next"]/main/div/section[1]/section/div[3]/section/section/div[3]/div[2]/div[1]/section/p/span[3]/text()').get()
        ...
        directors_query = response.xpath('//*[@id="__next"]/main/div/section[1]/section/div[3]/section/section/div[3]/div[2]/div[1]/section/div[2]/div/ul/li[1]/div/ul/li')
        directors = []
        for li in directors_query:
            director = li.xpath('normalize-space(.)').get()
            directors.append(director)

        budget = response.xpath('//*[@id="__next"]/main/div/section[1]/div/section/div/div[1]/section[11]/div[2]/ul/li[1]/div/ul/li/span/text()').get()
        gross_worldwide = response.xpath('//*[@id="__next"]/main/div/section[1]/div/section/div/div[1]/section[11]/div[2]/ul/li[4]/div/ul/li/span/text()').get()

        origin_countries_query = response.xpath('//*[@id="__next"]/main/div/section[1]/div/section/div/div[1]/section[10]/div[2]/ul/li[2]/div/ul/li')
        origin_countries = []
        for li in origin_countries_query:
            origin_country = li.xpath('.//a/text()').get()
            origin_countries.append(origin_country)

        origin_language = response.xpath('//*[@id="__next"]/main/div/section[1]/div/section/div/div[1]/section[10]/div[2]/ul/li[4]/div/ul/li/a/text()').get()


        companies_query = response.xpath('//*[@id="__next"]/main/div/section[1]/div/section/div/div[1]/section[10]/div[2]/ul/li[7]/div/ul/li')
        production_companies = []
        for li in companies_query:
            production_company = li.xpath('.//a/text()').get()
            production_companies.append(production_company)
        
        wins = response.xpath('//*[@id="__next"]/main/div/section[1]/div/section/div/div[1]/section[1]/div/ul/li/div/ul/li/span/text()').get()
        nominations = response.xpath('//*[@id="__next"]/main/div/section[1]/div/section/div/div[1]/section[1]/div/ul/li/a[1]/text()').get()
        ...
        if not response.xpath('//*[@id="__next"]/main/div/section[1]/div/section/div/div[1]/section[4]/div[2]/div[2]/div/div[2]/a/text()').get() is None:
            cast_table_query = response.xpath('//*[@id="__next"]/main/div/section[1]/div/section/div/div[1]/section[4]/div[2]/div[2]/div')
            cast = []
            ...
            cast_table_query = response.xpath('//*[@id="__next"]/main/div/section[1]/div/section/div/div[1]/section[3]/div[2]/div[2]/div')
            cast = []
